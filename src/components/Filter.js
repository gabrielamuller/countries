...
const Filter = ({ onChange, value }) => {
	return (
		<div className="filter__box">
			<h1 className="filter__heading">Welcome to Explore the World! 🌍</h1>
			...
			<div className="filter__search-form">
				<label htmlFor="country-search" className="filter__search-label">Search for a country:</label>
				<input id="country-search" className="filter__search-input" onChange={onChange} value={value} type="search" placeholder="Type a country name" aria-label="Type a country name"/>
			</div>
		</div>
	)
}
